...
public class App3 {
    public static void main(String[] args) {
        ...
        teacherController.create("cName14", "bSurname1", 23);
        teacherController.create("aName2", "aSurname2", 24, "Graduate1");
        teacherController.create("bName13", "bSurname23", 24, "Graduate2");
        List<Teacher> teacherList = teacherController.getAllTeachers();
        System.out.println(teacherList);
        List<Teacher> sortedTeacherList = teacherController.getSortedByFIOTeachers(teacherList);
        System.out.println(sortedTeacherList);
        System.out.println(new AverageAge<>(teacherList));
